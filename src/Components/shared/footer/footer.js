      ...
      <div className='sec-footer bgImg' style={{backgroundImage:`url(${require('../../../img/footer.png')})`}}  >
       ...
       <div className="row">
        ...
        <div className='footer-cr' style={{fontSize:'18px'}}>
          <i className="fab fa-square-facebook mr-2"/> <i className="fab fa-square-twitter mr-2"/> <i className="fas fa-envelope mr-2"/> <i className="fab fa-square-youtube mr-2"/> <i className="fab fa-linkedin mr-2"/> <i className="fab fa-square-whatsapp mr-2"/> <i className="fab fa-square-instagram mr-2"/> 
          </div>
        </div>
       </div>
      </div>
